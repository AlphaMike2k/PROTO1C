...
public class Proto1C {
    ...
    private static void createTables(Connection conn) {
        Statement stmt = null;
            ...
            stmt.execute("create table Task(TaskID AUTOINCREMENT PRIMARY KEY, TaskName char(30) not null, TaskDateTime DateTime not null);");
            
            stmt.execute("create table Budget(CurrentBudget INTEGER);");
