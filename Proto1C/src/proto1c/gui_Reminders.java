...
public class gui_Reminders extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.getAccessibleContext().setAccessibleName("Date");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gui_Reminders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gui_Reminders().setVisible(true);
            }
        });
    }
